    ...
    for child in elem.children:
        ...
        if isinstance(child, NavigableString):
            ...
            if child.name in ["h1", "h2", "h3", "h4", "h5", "h6"]:
                ...
                parent2 = child.find_parent("div", class_="figure")
                if parent:
                    print("parent2")
                    cap_parent = parent.find("figcaption")
                    if cap_parent:
                    ...
                    fig_cap = parent2.find("p", class_=["figurecaption", "title"])
                    if fig_cap:
